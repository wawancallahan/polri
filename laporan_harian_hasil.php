    ...
    <div class="container-fluid">
        ...
        <div class="header text-center">
            ...
            <div class="header-subtitle">
                Nomor:Sprin/675/XII/2021 /Sek KP Smd 
            </div>
        </div>
        <div class="kegiatan">
            <table class="table no-border">
                <tr>
                    ...
                    <td width="74%">
                        <ol type="1" class="dasar-kegiatan">
                            <li>UU Nomor 2 tahun 2002 tentang Kepolisian Negara Republik Indonesia</li>
                            <li>UU Nomor 2 tahun 2002 tentang Kepolisian Negara Republik Indonesia</li>
                            <li>UU Nomor 2 tahun 2002 tentang Kepolisian Negara Republik Indonesia</li>
                            <li>UU Nomor 2 tahun 2002 tentang Kepolisian Negara Republik Indonesia</li>
                        </ol>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                    Hari Rabu tanggal 01 Desember  2021 Pukul. 08.30 s/d 19.30 wita
                    </td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td>
                    Jl.Yos Soerdarso,Jl.P Suriansyah, jl Lumba lumba ,jl.gajah mada,jl.RE Martadinata, Jl. Slamet Riyadi, Jl.Untung Suropati dan jl.KH.Mas Mansyur Loa bakung Samarinda
                    </td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td>
                    Mobil patroli No.Pol. : 3110-XII, motor patroli XII 2007-31 dan XII 2006-31
                    </td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td>
                    keberangkatan kapal penumpang serta bongkar muatan kapal yg muat handak dan pupuk dipelabuhan samarinda serta  bongkar muat kapal yang muat buah dan sayur2an dan ikan  di dermaga pasar pagi  Samarinda
                    </td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td>
                    Melaksanakan pengamanan dan mengatur lalulintas orang dan kendaran di sekitar pelabuhan samarinda dan dermaga pasar pagi samarinda
                    </td>
                </tr>
            </table>
        </div>
